...
const featuredPosts: Post[] = [
  {
    ...
    excerpt:
      "A comprehensive guide to building modern web applications with Next.js and TypeScript",
  ...
  },
  {
    ...
    excerpt:
      "Learn how to implement type-safe routing in your Next.js applications",
...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section>
        <Link href="/tweeter" className="text-2xl text-indigo-200">
          To tweet page
        </Link>
      </section>
      <button onClick={() => router.push("/tweeter")}>
        go to tweet page but with router
      </button>
