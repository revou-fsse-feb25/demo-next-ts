  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Next.js Data Fetching Patterns</h1>
        <p className="text-gray-400">Simple demonstrations of various data fetching strategies</p>
      </header>

      <main className="grid grid-cols-1 gap-8 md:grid-cols-2">
        {/* 1. Server-side Rendering */}
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">1. Server-Side Rendering</h2>
          <DemoSSR todos={todos} />
        </section>

        {/* 2. Dynamic data fetching */}
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">2. Dynamic Data Fetching</h2>
        ...
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">3. SSR + Client State</h2>
        ...
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">4. Client-Side Fetching (SWR)</h2>
          <DemoClientSWR initialPostId={1} />
        </section>

        {/* 5. Loading states */}
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">5. Loading States</h2>
          <DemoLoadingStates />
        </section>

        {/* 6. Error handling and retry */}
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">6. Error Handling & Retry</h2>
          <DemoErrorHandling />
        </section>

        {/* 7. Caching and revalidation */}
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">7. Caching & Revalidation</h2>
          <DemoCaching />
        </section>

        {/* 8. Performance considerations */}
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">8. Performance Considerations</h2>
        ...
        <section className="bg-gray-800 p-5 rounded-lg shadow-lg col-span-1 md:col-span-2">
          <h2 className="text-xl font-semibold mb-4 text-blue-300">9. Parallel Data Fetching</h2>
          <Suspense fallback={<LoadingState message="Loading parallel data..." />}>
            <DemoParallelFetch />
          </Suspense>
        </section>
      </main>
      ...
      <footer className="mt-12 text-center text-gray-500 text-sm">
        ...
        <p>Using <a href="https://jsonplaceholder.typicode.com/" className="underline hover:text-gray-400">JSONPlaceholder</a></p>
      </footer>
    </div>
  );
}
